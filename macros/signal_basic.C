...
void
signal_basic(const std::string reference_filename, int reference_channel, const std::string reference_calibfilename,
	     ...
	     const std::string outfilename)
{
  ...
  collect_hits(target_hits, target_filename, target_channel, target_calibfilename);
...
void
collect_hits(hitmap_t &hits, const std::string filename, int channel, const std::string calibfilename)
{
